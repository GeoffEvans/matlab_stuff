...
%Xp=coordinates(0,:)';%([0.0 -0.0 0.0])% Sequence of X coordinates of Grid Point Centres pointed at (Normalised to lie between -1 and +1)
%Yp=coordinates(1,:)';%([-0.00 0.0 -0.00])% Sequence of Y coordinates Grid Point Centres to be pointed at (Normalised to lie between -1 and +1)
%Zp=coordinates(2,:)';%([0.3 0.00 .5])% Sequence of Z coordinates of Grid Point Centres to be pointed at (Normalised to lie between -1 and +1)
