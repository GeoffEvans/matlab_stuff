function [ displacementVector, dThetaAir, dPhi, dInten, dPol ] = aod_propagator( iThetaAir, iPhi, iInten, iPolAir, acFreq, acTheta, acPower, transducerLength, opWavelenVac )
...
% efficiency and emitted with a new polarisation.
    ...
    [diffractionEfficiencies, dThetaCrystal, dPhi ] = aod3d.rescattered_efficiency( iThetaCrystal, iPhi, acFreq, acTheta, acPower, transducerLength, opWavelenVac );
...
function disp = GetDisplacementInCrystal(dThetaCrystal,dPhi)
    ...
    aodWidth =8e-3;
    disp =  directionInCrystal ./ repmat(directionInCrystal(3,:),3,1) * aodWidth;
end
