function [eff, dTheta, dPhi] = rescattered_efficiency( iTheta, iPhi, acFreq, acTheta, acPower, transducerLength, opWavelenVac )
...
eff = effPrimary .* (1 - effSecondary);
    ...
    [ dTheta, dPhi, phaseOffset ] = aod3d.match_phase(iTheta,iPhi,acFreq,acTheta,opWavelenVac);
