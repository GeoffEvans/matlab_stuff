classdef aod3d < handle
        
    methods (Static)        % Externally defined
        [ dTheta, dPhi, phaseOffset ] =         match_phase( iTheta, iPhi, acFreq, acTheta, opWavelenVac )
        [eff, dTheta, dPhi] =                   rescattered_efficiency( iTheta, iPhi, acFreq, acTheta, acPower, transducerLength, opWavelenVac )
        [dispVec,dThetaAir,dPhi,dInten,dPol] =  aod_propagator( iThetaAir, iPhi, iInten, iPolAir, acFreq, acTheta, acPower, transducerLength, opWavelenVac )
        [dispVec,dWavevectorAir,dInten,dPol ] = aod_propagator_vector( iWavevectorAir, iInten, iPolAir, acFreq, acPower, transducerLength, opWavelenVac )
