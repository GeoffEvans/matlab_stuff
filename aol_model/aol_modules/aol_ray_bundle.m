...
% time,position,efficiency,momentum,centreOfAod,driveFreqs,perturbationOfAod
    ...
    methods
        function obj = aol_ray_bundle(microSecs,xyInputMm,drives,aodCentres,zFocusPredicted,aolPerturbs,opWavelenVac)
            if nargin == 0
                microSecs = 0;
                xyInputMm = [0;0];
            end
            ...
            obj.k = repmat([0;0;1]*2*pi/opWavelenVac,repmatArrayK); % input laser is orthogonal to AOD centre line
