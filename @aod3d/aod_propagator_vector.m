function [ dispVec, dWavevectorAir, dInten, dPol  ] = aod_propagator_vector( iWavevectorAir, iInten, iPolAir, acFreq, acPower )
acTheta = pi/2 + 0*iInten;
[ wavevector, iThetaAir, iPhi ] = get_angles_from_vector( iWavevectorAir );
[ dispVec, dThetaAir, dPhi, dInten, dPol ] = aod3d.aod_propagator( iThetaAir, iPhi, iInten, iPolAir, acFreq, acTheta, acPower );
